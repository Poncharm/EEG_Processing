...
# chb24
# FILES = [[r'D:\PythonProjects\EEG_Processing\Data_eeg\Personal states\Жевание.edf', [5, 50]],
#          [r'D:\PythonProjects\EEG_Processing\Data_eeg\Personal states\Напряжение мышц лица.edf', [5, 50]],
#          [r'D:\PythonProjects\EEG_Processing\Data_eeg\Personal states\Моргание.edf', [5, 50]],
#          [r'D:\PythonProjects\EEG_Processing\Data_eeg\Personal states\Приседания.edf', [5, 50]],
#          [r'D:\PythonProjects\EEG_Processing\Data_eeg\Personal states\Расслабленное состояние.edf', [5, 50]],
#          [r'D:\PythonProjects\EEG_Processing\Data_eeg\Personal states\Хождение по комнате.edf', [5, 50]],
#          [r'D:\PythonProjects\EEG_Processing\Data_eeg\Personal states\Кивание.edf', [5, 50]]]
#
# REQUIRED_CHANNELS = ["F3"]

FILES = [[r'Data_eeg\1.24 (The only work)\chb24_01.edf', [35, 50]],
         [r'Data_eeg\1.24 (The only work)\chb24_03.edf', [35, 50]],
         [r'Data_eeg\1.24 (The only work)\chb24_04.edf', [35, 50]],
         [r'Data_eeg\1.24 (The only work)\chb24_06.edf', [35, 50]],
         [r'Data_eeg\1.24 (The only work)\chb24_07.edf', [35, 50]],
         [r'Data_eeg\1.24 (The only work)\chb24_09.edf', [35, 50]]]
...
if __name__ == "__main__":
    ...
    zeros_classes = np.zeros((len(AVERAGED_POWER),), dtype=int)
    zeros_data = np.column_stack((AVERAGED_POWER, SD, ZEROS))

    with open('zeros_data.pkl', 'wb') as f:
        pickle.dump((zeros_data, zeros_classes), f)
